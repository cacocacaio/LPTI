									...
									<form method="post" action="addMembro.php" name="realizarDoacao" class="form-horizontal text-left" role="form" onSubmit="return verificaDoacao()">
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-10">
												...
												<input name="endereço" type="text" required="required" class="form-control input-lg" id="inputPassword3" placeholder="Qual o nome do evento?">
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-2">
												...
												<label for="inputEmail3" class="control-label">Quantidade de Membros</label>
											</div>
											
											<div class="col-sm-10">
												
												<input name="qtdMembros" type="text" required="required" name="numbers" pattern="[0-9]+$" title="Somente números." class="form-control input-lg" id="inputPassword3" placeholder="Quanto será doado do produto?">
