									...
									<form method="post" action="/add/addEstoque.php" name="realizarDoacao" class="form-horizontal text-left" role="form" onSubmit="return verificaDoacao()">
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-10">
												...
												<input name="quantidade" type="text" required="required" name="numbers" pattern="[0-9]+$" title="Somente números." class="form-control input-lg" id="inputPassword3" value="<?php echo $estoque->quantidade ?>">
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-10">
												...
												<input name="data" type="text" class="form-control input-lg" id="data" value="<?php echo $estoque->data ?>" readonly>
											</div>
										</div>
