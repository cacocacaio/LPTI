						...
						<div class="col-md-4" id="formulario">
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<form method="post" action="addEstoque.php" name="realizarDoacao" class="form-horizontal text-left" role="form" onSubmit="return verificaDoacao()">
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-10">
												...
												<input name="quantidade" type="text" required="required" name="numbers" pattern="[0-9]+$" title="Somente números." class="form-control input-lg" id="inputPassword3" placeholder="Quanto será doado/recebido do produto?">
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-10">
												...
												<input name="data" type="text" class="form-control input-lg" id="data" placeholder="Quando esse produto foi doado/arrecadado?" readonly>
											</div>
										</div>
										...
										<div class="form-group has-feedback">
											...
											<div class="col-sm-10">
												...
												<input name="usuario" type="text" class="form-control input-lg" value="Usuário" readonly>
											</div>
										</div>
